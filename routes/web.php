...
// Route::get('/showTests', function () {
//     return view('showtestcases');
// });
Route::get('showTests',App\Http\Livewire\ShowTestCases::class)->name('show_tests');
Route::get('test_case/{id}',App\Http\Livewire\Admins\SingleTest::class)->name('show_tests');
