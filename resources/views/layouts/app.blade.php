        ...
        <div class="header-top wow fadeIn">
            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><img
                        src="{{ $app ? config('app.url') . 'storage/' . $app->logo_path :  config("app.url").'images/anaxilogo.png' }}"
                        alt="logo image " height="80px"></a>
                      
                <div class="right-header">
                    <div class="header-info">
                        <div class="info-inner" >
                            <span class="icontop" style="background-color: #068a22;"
                            ><img src="{{ config('app.url') }}images/phone-icon.png" alt="#"></span>
                            <span class="iconcont"><a
                                    href="tel:{{ $app ? $app->business_phone : '9999503776' }}">{{ $app ? $app->business_phone : '9999503776' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"  style="background-color: #068a22;"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $app ? $app->business_email : 'Neeraj.kaul@anaxi.com' }}">{{ $app ? $app->business_email : 'Neeraj.kaul@anaxi.com' }}</a></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <nav class="main-menu">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dpdwn" onclick="check_active('Test Plans')"><a id="Services" data-scroll
                                    href="{{ url('/services') }}">Test Plans</a>
                                    <ul>
                                        <li><a>Create new</a></li>
                                    </ul>
                                    <ul>
                                        <li><a>Show Test Plans</a></li>
                                    </ul>
                                </li>
                            ...
                            <li onclick="check_active('Showtest')"><a id="Contact" data-scroll
                                    href="{{ url('/showTests') }}">Test Cases</a></li>
                            @auth
                                @if (auth()->user()->is_super_admin)
                                    <li onclick="check_active('admin-area')"><a id="admin-area" data-scroll
                                            href="{{ route('admin_settings') }}">Admin</a></li>
                                @endif
                            @endauth
